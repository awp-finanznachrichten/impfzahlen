###Check Impffrequenz
if (impfdaten_meldung$impfungen_last_week[1] > 200000 ) {

  ###Create Flash DE
  flash <- "BAG: Erstmals mehr als 200'000 Impfungen innert 7 Tagen"
  ...
  ###Create Flash FR
  flash <- "OFSP: cap franchi des 200'000 vaccinations en 7 jours"
