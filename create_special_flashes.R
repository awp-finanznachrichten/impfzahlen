###Check Impffrequenz
if (impfdaten_meldung$impfungen_last_week[1] > 300000 ) {

  ###Create Flash DE
  flash <- "BAG: Erstmals mehr als 300'000 Impfungen innert 7 Tagen"
  ...
  ###Create Flash FR
  flash <- "OFSP: cap franchi des 300'000 vaccinations en 7 jours"
  ...
  blat(f = "robot-notification@awp.ch",
       ...
       s = "Erstmals mehr als 300'000 Impfungen innert 7 Tagen",
       body= paste0("Liebes SDA-Team,\n\n",
                    "Die Impffrequenz steigt weiter: Erstmals wurden in der Schweiz innerhalb einer Woche über 300'000 Impfdosen verabreicht.\n\n",
                    "Liebe Grüsse\n\n",
                    "AWP-Robot"),
