...
if (impfdaten_meldung$impfungen_last_week[1] > 700000 ) {
  ...
  ###Create Flash FR
  flash <- "OFSP: cap franchi des 700'000 vaccinations en 7 jours"
  ...
  blat(f = "robot-notification@awp.ch",
       ...
       s = "Erstmals mehr als 700'000 Impfungen innert 7 Tagen",
       body= paste0("Liebes SDA-Team,\n\n",
                    "Die Impffrequenz steigt weiter: Erstmals wurden in der Schweiz innerhalb einer Woche über 700'000 Impfdosen verabreicht.\n\n",
                    "Liebe Grüsse\n\n",
                    "AWP-Robot"),
