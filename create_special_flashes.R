...
if (anteil_bevoelkerung > 10 ) {
  
  ###Create Flash DE
  flash <- "BAG: Über 10 Prozent der Schweizer Bevölkerung vollständig geimpft"
  ...
  ###Create Flash FR
  flash <- "OFSP: 10% de la population suisse complètement vaccinée"
  ...
  blat(f = "robot-notification@awp.ch",
       to = "robot-notification@awp.ch, inland@keystone-sda.ch, suisse@keystone-ats.ch, redazione@keystone-ats.ch, federico.bragagnini@keystone-ats.ch, thomas.oswald@keystone-sda.ch, nicola.wenger@keystone-ats.ch",
       s = "Über 10 Prozent der Bevölkerung vollständig geimpft",
       body= paste0("Liebes SDA-Team,\n\n",
                    "Ein erster Meilenstein ist erreicht: Über 10 Prozent der Schweizer Bevölkerung haben bereits zwei Impfdosen erhalten und sind damit vollständig geimpft.\n\n",
                    "Liebe Grüsse\n\n",
                    "AWP-Robot"),
       server = "smtp.juergruettimann.ch",
       u = "awp-robot@juergruettimann.ch",
